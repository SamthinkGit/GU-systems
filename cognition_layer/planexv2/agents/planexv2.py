    ...
    def iter(
        ...
        if not _planner_previous_output:
            ...
            yield PlanexV2Message(
                "planner", original_query, planner_output, is_last=False
            )
        else:
        ...
        if not _reducer_previous_output:
            ...
            steps += 1
            yield PlanexV2Message(
                "reducer", original_query, reducer_output, is_last=False
            )
        else:
        ...
        try:
            ...
            self._logger.debug("Task generated by Planex failed verification, calling to Blamer.")
            yield PlanexV2Message(
                "translator", original_query, translator_output, is_last=False
            )
            blame = BlameInfo(
            ...
            yield PlanexV2Message("blamer", original_query, response, is_last=False)
            steps += 1
        ...
        yield PlanexV2Message(
            "translator", original_query, translator_output, is_last=True
        )
        return
